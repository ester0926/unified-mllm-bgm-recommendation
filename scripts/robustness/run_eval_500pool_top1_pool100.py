...
"""VSCode-run wrapper: Top-1 end-to-end generation for 100-pool robustness."""
...
runner.POOL_SIZE = 100
runner.PROMPT_VARIANT = "original"
runner.RANKING_RESULT_TAG = "pool100"
runner.OUTPUT_TAG = "top1_pool100_prompt_original"
