...
"""VSCode-run wrapper: Top-1 end-to-end generation for 1000-pool robustness."""
...
runner.POOL_SIZE = 1000
runner.PROMPT_VARIANT = "original"
runner.RANKING_RESULT_TAG = "pool1000"
runner.OUTPUT_TAG = "top1_pool1000_prompt_original"
