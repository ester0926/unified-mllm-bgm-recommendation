...
"""
Prompt robustness eval: simplified prompt.

The simplified prompt keeps the same modality tokens but shortens the language
around them to test sensitivity to prompt verbosity.
"""
...
core.CKPT_NAME = "best"
core.POOL_SIZE = 500
core.PROMPT_VARIANT = "simple"
core.RESULT_TAG = "prompt_simple"
